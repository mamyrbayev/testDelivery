...
//                .antMatchers(SOCKET_URL).permitAll()
                ...
                .antMatchers(PAYMENT_URL).permitAll()
                .antMatchers(HttpMethod.GET, MEAL_URL).permitAll()
                .antMatchers(HttpMethod.GET, CATEGORY_URL).permitAll()
                .antMatchers(CATEGORY_ID_URL).permitAll()
                .antMatchers(MEAL_ID_URL).permitAll()
                .antMatchers(MEAL_BY_CATEGORY_ID_URL).permitAll()
